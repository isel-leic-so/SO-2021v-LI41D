...
// globals
static struct epoll_event clients[EPOOL_MAX_FDS]; 	// client descriptors
...
static void ah_do_async(async_handle_t ah, async_cb cb, void *ctx) {
	ah->cb = cb;
	ah->ctx = ctx;
}
...
int ah_getfd(async_handle_t ah) { return ah->fd; }
